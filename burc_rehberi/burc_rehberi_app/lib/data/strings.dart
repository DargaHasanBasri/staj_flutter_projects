class Strings {
  ...
  static const List<String> BURC_GENEL_OZELLIKLERI = [
    "\tYönetici yıldızınız: Mars\n\n"
        ...
        "\tUğurlu kokularınız: Manolya, lavanta,\n ıtır\n\n"
        "\tOlumlu özelliğiniz: Cesaret\n\n"
        "\tOlumsuz özelliğiniz: Acelecilik\n\n"
        "\tAnlaştığınız burçlar: Aslan, Yay\n\n"
        "\tAnlaşamadığınız burçlar:\n Yengeç, Terazi, Oğlak\n\n"
        "\tBaşarılı olacağınız meslekler:\n Politikacılık, yöneticilik, işletmecilik,\n mühendislik, ressamlık, müzisyenlik,\n oyunculuk\n\n"
        "\tBurcunuzdan olan ünlüler:\n Fatih Sultan Mehmet,Sakıp Sabancı,\n Descartes, Charlie Chaplin,\n Vincent Van Gogh, Zeki Alasya\n\n",
    "\tYönetici yıldızınız: Venüs\n\n"
        "\tGrubunuz: Toprak\n\n"
        "\tUğurlu gününüz: Cuma\n\n"
        "\tUğurlu sayınız: 6\n\n"
        "\tUğurlu renginiz: Pastel Mavi, Lila\n\n"
        "\tUğurlu taşlarınız: Krizokol, Turkuaz,\n Safir\n\n"
        "\tUğurlu çicekleriniz: Kırmızı gül,\n pembe karanfil ve şebboy\n\n"
        "\tUğurlu kokularınız: Karanfil, elma\n çiçeği\n\n"
        "\tOlumlu özelliğiniz: Güvenilirlik\n\n"
        "\tOlumsuz özelliğiniz: İnatçılık\n\n"
        "\tAnlaştığınız burçlar: Yengeç, Balık\n\n"
        "\tAnlaşamadığınız burçlar: Kova, Aslan,\n Akrep\n\n"
        "\tBaşarılı olacağınız meslekler:\n Askerlik, doktorluk, mimarlık, mühendislik, bankacılık\n\n"
        "\tBurcunuzdan olan ünlüler:\n Nükhet Duru, Öztürk Serengil, Salvadore Dali, Karl Marks, Lenin, Sigmund Freud, Shakespare\n\n",
